    ...
    <div class="content">
        ...
        <div class="block">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="">Create Role</a>
                        </li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="block-content block-content-full">
                ...
                {!! Form::open(['method' => 'POST', 'route' => ['admin.user_managements.roles.store'],'class'=>'js-validation', 'files' => true]) !!}
                {{--                @csrf--}}
                <div class="row">
                    <div class="col-lg-12 col-xl-10">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 form-group">
                                {!! Form::select('permissions[]', $permissions, old('permissions'), ['multiple'=>true,'class' => 'js-select2 form-control']) !!}
                                @error('permissions[]')
                                <span class="text-danger animated fadeIn">{{$message}}</span>
                                @enderror
                            </div>
                ...
                <a class="btn btn-alt-secondary float-right" href="{{route('admin.user_managements.roles.index')}}">Cancel</a>
                {!! Form::close() !!}
