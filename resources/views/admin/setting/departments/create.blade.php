                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 form-group">
                                <input type="text" class="form-control" id="name_kh" name="name_kh"
                                       placeholder="Type department name in Khmer..." autofocus>
                                @error('name_kh')
                                <span class="text-danger animated fadeIn">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 form-group">
                                <input type="text" class="form-control" id="abr" name="abr"
                                       placeholder="Type department abbreviation..." autofocus>
                                @error('abr')
                                <span class="text-danger animated fadeIn">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 form-group">
                                <input type="text" class="form-control" id="abr_kh" name="abr_kh"
                                       placeholder="Type department abbreviation in Khmer..." autofocus>
                                @error('abr_kh')
                                <span class="text-danger animated fadeIn">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8 form-group">
                                <input type="number" class="form-control" id="bed_total" name="bed_total"
                                       placeholder="Type total bed..." autofocus>
                                @error('bed_total')
                                <span class="text-danger animated fadeIn">{{$message}}</span>
                                @enderror
                            </div>
