                ...
                <div class="hero-inner text-center">
                    <div class="bg-white">
                        <div class="content content-full overflow-hidden">
                            <div class="py-4">
                                <!-- Error Header -->
                                <h1 class="display-1 text-amethyst invisible" data-toggle="appear" data-class="animated fadeInDown">401</h1>
                                <h2 class="h3 font-w300 text-muted invisible mb-5" data-toggle="appear" data-class="animated fadeInUp">We are sorry but you are not authorized to access this page..</h2>
                                <!-- END Error Header -->
