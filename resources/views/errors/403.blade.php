                    ...
                    <div class="bg-white">
                        <div class="content content-full overflow-hidden">
                            <div class="py-4">
                                ...
                                <h2 class="h3 font-w300 text-muted invisible mb-5" data-toggle="appear" data-class="animated fadeInUp">We are sorry but you do not have permission to access this page..</h2>
                                <!-- END Error Header -->
